...
source_url("https://github.com/LuiseNagel/Global-analyses-of-the-human-structural-proteome-to-identify-a-new-type-of-disease-biomarker/blob/main/Functions_StructuralVariabilityCSF.R?raw=TRUE")
